...
export interface ApiProprietePropriete extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Evaluations_Taxes_Depenses: Schema.Attribute.Component<
    ...
    Garantie: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    Image_Presentation: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    ...
    >;
    Numero_Centris: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    Pieces_et_particularites_exterieures: Schema.Attribute.Component<
      'pieces-et-particularites-exterieures.pieces-et-particularites-exterieures',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
